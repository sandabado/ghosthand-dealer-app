...
export default function Connections(){
  ...
  return <PrototypeShell eyebrow="JOURNEY 01 · CONNECTED OPERATIONS" title="Connect your operating picture." description="See the customer, revenue, and capacity signals that disappear between departmental exports." actions={
    ...
    <a href="/onboarding/step-1" className="proto-btn dark">See your connections →</a>
  }>
